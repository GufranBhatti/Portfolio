...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            ...
            st.write("📄 [Resume](https://drive.google.com/file/d/1T1VLEoG5apKWnQDtx3dZF_um7aPE2k5L/view?usp=sharing)")
        with middle_column:
            st.empty()
        with right_column:
            st.image(img_utown)
...
#st.write("---")
    ...
    resume_url = "https://drive.google.com/file/d/1T1VLEoG5apKWnQDtx3dZF_um7aPE2k5L/view?usp=sharing"
    st.header("Resume")
